...
public class ScoreObjectMix extends SequentialCommandGroup {
   ...
   */
  public ScoreObjectMix(RotatingArm arm, Elevator elevator, Claw claw, Drivetrain drivetrain) {
    addRequirements(arm, elevator, claw);
    addCommands(
      new MoveClawToPoint(arm, elevator, 46.0, distance), // distance depends on robot length
      new MoveClawToPoint(arm, elevator, 36.0, distance), // distance depends on robot length
